...
TEST(BoxContainer, IteratePairs) {
    std::vector<Particle> particles = {
        ...
        Particle({ 1.9, 1.9, 0.5 }, {}, 5),
        Particle({ 3.5, 3.5, 0.5 }, {}, 6),
        Particle({ 3.5, 3.75, 0.5 }, {}, 7),
        Particle({ 3.5, 3.25, 0.5 }, {}, 8),
    };
...
TEST(BoxContainer, Constructor) {
    std::vector<Particle> particles = {
        Particle({ 1.3, 2.1, 0.0 }, { 3.0, 2.0, 4.0 }, 0),
        Particle({ 0.0, -1.3, -2.0 }, { 1.0, 2.2, -3.2 }, 1),
    };
...
TEST(BoxContainer, UpdatePosition) {
    std::vector<Particle> particles = {
        Particle({ 1.0, 1.0, 0.0 }, {}, 1),
        Particle({ 19.0, 1.0, 0.0 }, {}, 2),
        Particle({ 1.0, 19.0, 0.0 }, {}, 3),
        Particle({ 19.0, 19.0, 0.0 }, {}, 4),
    };
    ...
    box[0] = Particle({ 9.9, 9.9, 0.0 }, {}, 1);
    box[1] = Particle({ 10.1, 9.9, 0.0 }, {}, 2);
    box[2] = Particle({ 9.9, 10.1, 0.0 }, {}, 3);
    box[3] = Particle({ 10.1, 10.1, 0.0 }, {}, 4);
