 ...
 * @file
 *
 * @brief Handles lenard jones based physics calculations, including molecule
 */
...
namespace physicsCalculator {
     ...
     * @class MolCalculator
     *
     * @brief Class corresponding to a leap frog integrator using Lenard Jones potentials and molecules.
     */
    class MolCalculator : public Calculator {

    public:
        /**
         * Initialize a Lenard Jones Molecule calculator using a simulation environment.
         *
         ...
         */
        MolCalculator(const Environment& new_env, const std::shared_ptr<ParticleContainer>& new_cont);
         ...
         */
        MolCalculator(const Environment& new_env, const std::vector<Particle>& particles, const std::vector<TypeDesc>& new_desc,
            const bool init_forces = true, const bool is_infinite = true);

        /**
         * Define a constructor for a Lenard Jones Molecule calculator.
         */
        virtual ~MolCalculator();
