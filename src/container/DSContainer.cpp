...
DSContainer::DSContainer(const std::vector<Particle>& new_particles)
    : ParticleContainer(new_particles) { }

DSContainer::DSContainer(const std::array<double, 3>& new_domain)
    : ParticleContainer(new_domain) { }

DSContainer::DSContainer(const std::vector<Particle>& new_particles, const std::array<double, 3>& new_domain)
