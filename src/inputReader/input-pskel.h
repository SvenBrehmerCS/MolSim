...
#ifndef CXX___RES_INPUT_PSKEL_H
#define CXX___RES_INPUT_PSKEL_H
...
//
class sim_t_pskel;
class output_t_pskel;
class param_t_pskel;
class particle_t_pskel;
class cuboid_t_pskel;
...
class sim_t_pskel : public ::xml_schema::complex_content {
public:
    ...
    //
    void output_parser(::output_t_pskel&);

    void param_parser(::param_t_pskel&);

    void particle_parser(::particle_t_pskel&);

    void cuboid_parser(::cuboid_t_pskel&);

    void parsers(::output_t_pskel& /* output */, ::param_t_pskel& /* param */, ::particle_t_pskel& /* particle */, ::cuboid_t_pskel& /* cuboid */);
...
protected:
    ::output_t_pskel* output_parser_;
    ::param_t_pskel* param_parser_;
    ::particle_t_pskel* particle_parser_;
    ::cuboid_t_pskel* cuboid_parser_;
};

class output_t_pskel : public ::xml_schema::complex_content {
public:
    // Parser callbacks. Override them in your implementation.
    //
    // virtual void
    ...
    void parsers(::xml_schema::string_pskel& /* name */, ::xml_schema::int_pskel& /* frequency */);
...
class param_t_pskel : public ::xml_schema::complex_content {
public:
    // Parser callbacks. Override them in your implementation.
    //
    // virtual void
...
class particle_t_pskel : public ::xml_schema::complex_content {
public:
    // Parser callbacks. Override them in your implementation.
    //
    // virtual void
    ...
    // Parser construction API.
    //
    void pos_x_parser(::xml_schema::double_pskel&);

    void pos_y_parser(::xml_schema::double_pskel&);

    void pos_z_parser(::xml_schema::double_pskel&);

    void vel_x_parser(::xml_schema::double_pskel&);

    void vel_y_parser(::xml_schema::double_pskel&);

    void vel_z_parser(::xml_schema::double_pskel&);

    void m_parser(::xml_schema::double_pskel&);

    void parsers(::xml_schema::double_pskel& /* pos_x */, ::xml_schema::double_pskel& /* pos_y */, ::xml_schema::double_pskel& /* pos_z */,
        ::xml_schema::double_pskel& /* vel_x */, ::xml_schema::double_pskel& /* vel_y */, ::xml_schema::double_pskel& /* vel_z */,
...
protected:
    ::xml_schema::double_pskel* pos_x_parser_;
    ::xml_schema::double_pskel* pos_y_parser_;
    ::xml_schema::double_pskel* pos_z_parser_;
    ::xml_schema::double_pskel* vel_x_parser_;
    ::xml_schema::double_pskel* vel_y_parser_;
    ::xml_schema::double_pskel* vel_z_parser_;
    ::xml_schema::double_pskel* m_parser_;
};

class cuboid_t_pskel : public ::xml_schema::complex_content {
public:
    // Parser callbacks. Override them in your implementation.
    //
    // virtual void
    ...
    void b_motion_parser(::xml_schema::double_pskel&);

    void parsers(::xml_schema::double_pskel& /* pos_x */, ::xml_schema::double_pskel& /* pos_y */, ::xml_schema::double_pskel& /* pos_z */,
        ::xml_schema::double_pskel& /* vel_x */, ::xml_schema::double_pskel& /* vel_y */, ::xml_schema::double_pskel& /* vel_z */,
        ::xml_schema::double_pskel& /* m */, ::xml_schema::int_pskel& /* n_x */, ::xml_schema::int_pskel& /* n_y */,
        ::xml_schema::int_pskel& /* n_z */, ::xml_schema::double_pskel& /* h */, ::xml_schema::double_pskel& /* b_motion */);
...
protected:
    ...
    ::xml_schema::double_pskel* b_motion_parser_;
};
