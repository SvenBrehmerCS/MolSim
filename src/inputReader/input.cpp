...
const disc_t::c_x_type& disc_t::c_x() const { return this->c_x_.get(); }

disc_t::c_x_type& disc_t::c_x() { return this->c_x_.get(); }

void disc_t::c_x(const c_x_type& x) { this->c_x_.set(x); }

const disc_t::c_y_type& disc_t::c_y() const { return this->c_y_.get(); }

disc_t::c_y_type& disc_t::c_y() { return this->c_y_.get(); }

void disc_t::c_y(const c_y_type& x) { this->c_y_.set(x); }

const disc_t::c_z_type& disc_t::c_z() const { return this->c_z_.get(); }

disc_t::c_z_type& disc_t::c_z() { return this->c_z_.get(); }

void disc_t::c_z(const c_z_type& x) { this->c_z_.set(x); }

const disc_t::vel_x_type& disc_t::vel_x() const { return this->vel_x_.get(); }

disc_t::vel_x_type& disc_t::vel_x() { return this->vel_x_.get(); }

void disc_t::vel_x(const vel_x_type& x) { this->vel_x_.set(x); }

const disc_t::vel_y_type& disc_t::vel_y() const { return this->vel_y_.get(); }

disc_t::vel_y_type& disc_t::vel_y() { return this->vel_y_.get(); }

void disc_t::vel_y(const vel_y_type& x) { this->vel_y_.set(x); }

const disc_t::vel_z_type& disc_t::vel_z() const { return this->vel_z_.get(); }

disc_t::vel_z_type& disc_t::vel_z() { return this->vel_z_.get(); }

void disc_t::vel_z(const vel_z_type& x) { this->vel_z_.set(x); }
...
disc_t::b_motion_type disc_t::b_motion_default_value() { return b_motion_type(.1); }
...
disc_t::disc_t(const c_x_type& c_x, const c_y_type& c_y, const c_z_type& c_z, const vel_x_type& vel_x, const vel_y_type& vel_y,
    const vel_z_type& vel_z, const m_type& m, const r_type& r, const h_type& h, const b_motion_type& b_motion)
    : ::xml_schema::type()
    , c_x_(c_x, this)
    , c_y_(c_y, this)
    , c_z_(c_z, this)
...
void disc_t::parse(::xsd::cxx::xml::dom::parser<char>& p, ::xml_schema::flags f) {
    ...
    if (!c_x_.present()) {
        throw ::xsd::cxx::tree::expected_element<char>("c_x", "");
    }

    if (!c_y_.present()) {
        throw ::xsd::cxx::tree::expected_element<char>("c_y", "");
    }

    if (!c_z_.present()) {
        throw ::xsd::cxx::tree::expected_element<char>("c_z", "");
    }
