...
class particle_t: public ::xml_schema::type
{
   ...
   * @name pos_x
   *
   * @brief Accessor and modifier functions for the %pos_x
   * required element.
   *
   ...
   * @name pos_y
   *
   * @brief Accessor and modifier functions for the %pos_y
   * required element.
   *
   ...
   * @name pos_z
   *
   * @brief Accessor and modifier functions for the %pos_z
   * required element.
   *
   ...
   * @name vel_x
   *
   * @brief Accessor and modifier functions for the %vel_x
   * required element.
   *
   * The velocity of the particle in x direction.
   */
  //@{
   ...
   * @name vel_y
   *
   * @brief Accessor and modifier functions for the %vel_y
   * required element.
   *
   * The velocity of the particle in y direction.
   */
  //@{
   ...
   * @name vel_z
   *
   * @brief Accessor and modifier functions for the %vel_z
   * required element.
   *
   * The velocity of the particle in z direction.
   */
  //@{
...
class cuboid_t: public ::xml_schema::type
{
   ...
   * required element.
   *
   * The x coordinate of the base particle.
   */
  //@{
   ...
   * required element.
   *
   * The y coordinate of the base particle.
   */
  //@{
   ...
   * required element.
   *
   * The z coordinate of the base particle
   */
  //@{
   ...
   * required element.
   *
   * The rough velocity of the cuboid in x direction.
   */
  //@{
   ...
   * required element.
   *
   * The rough velocity of the cuboid in y direction.
   */
  //@{
   ...
   * required element.
   *
   * The rough velocity of the cuboid in z direction.
   */
  //@{
   ...
   * @name n_x
   *
   * @brief Accessor and modifier functions for the %n_x
   * required element.
   *
   * The amount of particles in x direction.
   */
  //@{
   ...
   * @name n_y
   *
   * @brief Accessor and modifier functions for the %n_y
   * required element.
   *
   * The amount of particles in y direction.
   */
  //@{
   ...
   * @name n_z
   *
   * @brief Accessor and modifier functions for the %n_z
   * required element.
   *
   * The amount of particles in z direction.
   */
  //@{
 ...
 * the simulation. @details This complex type consists of all the
 * parameters needed to
 * define a disc of particles, such as the position of the center of the
 * disc , the velocity of the disc, distance between particles, and more.
 *
 * @nosubgrouping
 */
class disc_t: public ::xml_schema::type
{
   ...
   * @name c_x
   *
   * @brief Accessor and modifier functions for the %c_x
   * required element.
   *
   ...
   * @brief Element type.
   */
  typedef ::xml_schema::double_ c_x_type;

  /**
   * @brief Element traits type.
   */
  typedef ::xsd::cxx::tree::traits< c_x_type, char, ::xsd::cxx::tree::schema_type::double_ > c_x_traits;
   ...
   * @name c_y
   *
   * @brief Accessor and modifier functions for the %c_y
   * required element.
   *
   ...
   * @brief Element type.
   */
  typedef ::xml_schema::double_ c_y_type;

  /**
   * @brief Element traits type.
   */
  typedef ::xsd::cxx::tree::traits< c_y_type, char, ::xsd::cxx::tree::schema_type::double_ > c_y_traits;
   ...
   * @name c_z
   *
   * @brief Accessor and modifier functions for the %c_z
   * required element.
   *
   * The z coordinate of the center of the disc
   */
  //@{
   ...
   * @brief Element type.
   */
  typedef ::xml_schema::double_ c_z_type;

  /**
   * @brief Element traits type.
   */
  typedef ::xsd::cxx::tree::traits< c_z_type, char, ::xsd::cxx::tree::schema_type::double_ > c_z_traits;
   ...
   * required element.
   *
   * The rough velocity of the disc in x direction.
   */
  //@{
   ...
   * required element.
   *
   * The rough velocity of the disc in y direction.
   */
  //@{
   ...
   * required element.
   *
   * The rough velocity of the disc in z direction.
   */
  //@{
   ...
   * required element.
   *
   * The radius in terms of the number of molecules along the radius.
   */
  //@{
  ...
  protected:
  ::xsd::cxx::tree::one< c_x_type > c_x_;
  ::xsd::cxx::tree::one< c_y_type > c_y_;
  ::xsd::cxx::tree::one< c_z_type > c_z_;
  ::xsd::cxx::tree::one< vel_x_type > vel_x_;
  ::xsd::cxx::tree::one< vel_y_type > vel_y_;
  ::xsd::cxx::tree::one< vel_z_type > vel_z_;
  ::xsd::cxx::tree::one< m_type > m_;
